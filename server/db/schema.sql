...
CREATE TABLE public.league (
    ...
    name character varying(1) DEFAULT 'A'::character varying NOT NULL,
...
CREATE TABLE public.player (
    ...
    highest_elo integer DEFAULT 1200 NOT NULL,
    is_elo_provisional boolean DEFAULT true NOT NULL,
    account_id uuid NOT NULL,
    current_league_id uuid,
    previous_league_id uuid,
    previous_league_rank integer,
    is_playing_next_season boolean DEFAULT true,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);
...
--
-- Name: player player_previous_league_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.player
    ADD CONSTRAINT player_previous_league_id_fkey FOREIGN KEY (previous_league_id) REFERENCES public.league(id);
