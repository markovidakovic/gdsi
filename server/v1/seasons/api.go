...
func (a *api) Mount(r chi.Router) {
	...
	r.Get("/{seasonId}", a.hdl.getSeason)
	r.With(middleware.RequirePermission(permission.UpdateSeason)).Put("/{seasonId}", a.hdl.updateSeason)
	r.With(middleware.RequirePermission(permission.DeleteSeason)).Delete("/{seasonId}", a.hdl.deleteSeason)
}
